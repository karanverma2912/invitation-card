...
export function OmkareshwarIntro() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[680px] py-20 md:py-24 flex items-center justify-center overflow-hidden bg-brand-cream"
    >
      {/* Background Parallax */}
      <motion.div
      ...
      >
        ...
        <div className="flex-1 relative">
          <motion.div
            className="relative w-[min(72vw,320px)] h-[380px] mx-auto md:ml-auto border-8 border-brand-maroon/30 rounded-t-full overflow-hidden shadow-[0_0_30px_rgba(128,0,32,0.2)]"
