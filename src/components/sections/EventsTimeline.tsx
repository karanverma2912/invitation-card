...
export function EventsTimeline() {
  ...
  return (
    <section ref={containerRef} className="py-32 bg-brand-cream relative">
      <div className="container mx-auto px-4 md:px-12">
        ...
        >
          <h2
            lang="hi"
            className="text-4xl md:text-6xl font-serif text-brand-maroon mb-4"
          >
            विवाह के शुभ उत्सव
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`ml-12 w-[calc(100%-3rem)] md:ml-0 md:w-[45%] p-6 md:p-8 rounded-xl bg-white border border-brand-gold/20 shadow-lg transition-all duration-300 relative group overflow-hidden ${
                      isEven
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      {event.location && (
                        <p className="text-brand-gold font-sans mt-2">
                          {event.location}
                        </p>
                      )}
                    </div>
