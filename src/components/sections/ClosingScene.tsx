  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center bg-brand-dark overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[url('/images/maheshwar/intro_hq.jpg')] bg-cover bg-bottom opacity-40 mix-blend-screen grayscale" />
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <h3
            lang="hi"
            className="text-brand-gold text-3xl font-serif tracking-widest"
          >
            शुभ विवाह
          </h3>
        </div>
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <div
            ...
            style={{
              left: `${20 + ((i * 17) % 60)}%`,
              bottom: `-10%`,
              animation: `floatUpSlow ${15 + (i % 10)}s linear infinite`,
